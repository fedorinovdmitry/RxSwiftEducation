...
class GifMainTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        .flatMapLatest { query -> Observable<[GiphyGif]> in
            return GifApiController.shared.search(text: query)
                .catchAndReturn([])
        }
...
extension GifMainTableViewController: UISearchResultsUpdating {
